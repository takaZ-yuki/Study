    ...
    Protected Sub Page_Load() Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            If message IsNot Nothing Then
                ...
                SuccessMessage = If(message = "ChangePwdSuccess", "パスワードが変更されました。", 
                    If(message = "SetPwdSuccess", "パスワードが設定されました。", 
                    If(message = "RemoveLoginSuccess", "アカウントは削除されました。", 
                    If(message = "AddPhoneNumberSuccess", "電話番号が追加されました", 
                    If(message = "RemovePhoneNumberSuccess", "電話番号が削除されました", String.Empty)))))
