<%@ Page Title="パスワードの再設定" Language="vb" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ResetPassword.aspx.vb" Inherits="SampleAPP.ResetPassword" Async="true" %>
    ...
    <div class="form-horizontal">
        ...
        <div class="form-group">
            <div class="col-md-offset-2 col-md-10">
                <asp:Button runat="server" OnClick="Reset_Click" Text="再設定" CssClass="btn btn-default" />
            </div>
        </div>
    </div>
</asp:Content>
